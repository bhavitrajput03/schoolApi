...
GO
IF OBJECT_ID('dbo.ApiUser','U') IS NULL
...
CREATE TABLE dbo.ApiAuthToken(
 ...
 CONSTRAINT FK_ApiToken_User FOREIGN KEY(ApiUserID) REFERENCES dbo.ApiUser(ApiUserID));
GO
...
CREATE TABLE dbo.ApiTeacherAssignment(
 ...
 CONSTRAINT FK_ApiAssignment_User FOREIGN KEY(ApiUserID) REFERENCES dbo.ApiUser(ApiUserID),
