...
final class NoticeController {
    public function list(Request $r,array $p,int $student):never{
        $ctx=ParentService::student($p,$student);$sql="SELECT n.AppNoticeID id,n.Title title,n.Body body,n.PublishedAt publishedAt,n.PublishedBy publishedBy,CAST(CASE WHEN rd.AppNoticeID IS NULL THEN 0 ELSE 1 END AS bit) isRead
